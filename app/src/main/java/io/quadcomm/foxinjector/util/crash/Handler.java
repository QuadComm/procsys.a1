package io.quadcomm.foxinjector.util.crash;
...
public final class Handler {
	...
	public static void init(final Context app, final String log_file) {
		Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
			...
			private void tryUncaughtException(Thread thread, Throwable throwable) {
				...
				String fileName = log_file + time + ".txt";
				String dirName;
				...
				Toast.makeText(app, "App has crashed unexpectedly", Toast.LENGTH_LONG).show();
